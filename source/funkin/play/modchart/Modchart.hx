...
class Modchart
{
  ...
  public function GetYPos(iCol:Int, fYOffset:Float, xOffset:Array<Float>, down:Bool, WithReverse:Bool = true, isHoldBody:Bool = false):Float
  {
    ...
    if (WithReverse)
    {
      ...
      var fShift:Float = ModchartMath.scale(fPercentReverse, 0, 1, -2 * ARROW_SIZE / zoom, 2 * ARROW_SIZE / zoom);
      fShift = ModchartMath.scale(getValue('centered') + getValue('centeredcol$iCol'), 0., 1., fShift, 0);
  ...
  public function GetZPos(iCol:Int, fYOffset:Float, xOffset:Array<Float>):Float
  {
    var f:Float = 0;
    var time:Float = getTime();
  ...
  public function GetScale(iCol:Int, fYOffset:Float, isHoldBody:Bool = false, isNote:Bool = false):Array<Float>
  {
    var x:Float = 1;
    var y:Float = 1;
    var z:Float = 1;
